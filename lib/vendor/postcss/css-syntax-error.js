...
const _supportsColor = require('supports-color')

const _supportsColor2 = _interopRequireDefault(_supportsColor)

const _terminalHighlight = require('./terminal-highlight')

const _terminalHighlight2 = _interopRequireDefault(_terminalHighlight)
