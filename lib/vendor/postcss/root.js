...
const _lazyResult2 = _interopRequireDefault(_lazyResult)
 ...
 * root.nodes.length //=> 2
 */
const Root = (function (_Container) {
  _inherits(Root, _Container)

  function Root(defaults) {
    _classCallCheck(this, Root)

    const _this = _possibleConstructorReturn(this, (Root.__proto__ || Object.getPrototypeOf(Root)).call(this, defaults))
  ...
  _createClass(Root, [{
    ...
    value: function normalize(child, sample, type) {
      const nodes = _get(Root.prototype.__proto__ || Object.getPrototypeOf(Root.prototype), 'normalize', this).call(this, child)
    ...
    value: function toResult() {
      ...
      const lazy = new _lazyResult2.default(new _processor2.default(), this, opts)
