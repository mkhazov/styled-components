...
const _isFunction = require('is-function')
...
const _createBroadcast = require('../utils/create-broadcast')

const _createBroadcast2 = _interopRequireDefault(_createBroadcast)
...
const babelPluginFlowReactPropTypes_proptype_Broadcast = require('../utils/create-broadcast').babelPluginFlowReactPropTypes_proptype_Broadcast || require('react').PropTypes.any

const CHANNEL = exports.CHANNEL = '__styled-components__'
...
const ThemeProvider = (function (_Component) {
  ...
  function ThemeProvider() {
    ...
    const _this = _possibleConstructorReturn(this, (ThemeProvider.__proto__ || Object.getPrototypeOf(ThemeProvider)).call(this))
